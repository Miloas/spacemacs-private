...
(defun miloas-lsp/init-company-lsp ()
...
(defun miloas-lsp/init-flycheck-lsp ()
  ;; Disable lsp-flycheck.el in favor of lsp-ui-flycheck.el
  (setq lsp-enable-flycheck nil))

(defun miloas-lsp/init-lsp-mode ()
