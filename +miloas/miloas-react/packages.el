...
(defun miloas-react/init-rjsx-mode ()
...
(defun miloas-react/post-init-tern ()
  (add-hook 'rjsx-mode-hook 'tern-mode)
  (spacemacs|hide-lighter tern-mode)
  (spacemacs//set-tern-key-bindings 'rjsx-mode))

(defun miloas-react/post-init-web-beautify ()
